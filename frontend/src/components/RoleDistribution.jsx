...
export default function RoleDistribution({ data }) {
  ...
  const COLORS = ["#4ade80","#60a5fa","#f472b6","#fbbf24","#34d399","#a78bfa","#fb7185"];
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <ul className="space-y-2">
          {roles.map((r, i) => (
            <li key={i} className="flex justify-between items-center p-3 bg-white/5 rounded-lg text-white">
