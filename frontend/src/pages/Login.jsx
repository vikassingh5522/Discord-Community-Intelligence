      ...
      >
        ...
        <form onSubmit={submit} className="space-y-4">
          <motion.input
            ...
            className="w-full p-3 bg-white/20 border border-white/40 rounded-lg text-white placeholder-gray-200 focus:bg-white/30 focus:outline-none transition"
          ...
          <motion.button
            ...
            className="w-full bg-indigo-500 hover:bg-indigo-400 transition-all p-3 rounded-xl font-semibold text-white shadow-lg"
          >
